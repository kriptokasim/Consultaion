...
ALL_MODELS: List[ModelInfo] = [
    ModelInfo(
        ...
        provider="openrouter",
        litellm_model="openrouter/openai/gpt-4o-mini",  # openrouter/router is not a valid litellm string
    ...
    ModelInfo(
        ...
        provider="openrouter",
        litellm_model="openrouter/openai/gpt-4o",  # openrouter/auto is not a valid litellm string
