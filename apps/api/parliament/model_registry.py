...
ALL_MODELS: List[ModelInfo] = [
    ...
    ModelInfo(id="router-deep", display_name="Laguna S 2.1 Free (OpenRouter)", provider="openrouter", litellm_model="openrouter/poolside/laguna-s-2.1:free", capabilities={"chat","routing","reasoning","tools"}, tier="advanced", cost_tier="low", latency_class="normal", quality_tier="advanced", safety_profile="normal", logo_url="/logos/openrouter.svg"),
    ...
    ModelInfo(id="openrouter-nemotron-free", display_name="Nemotron 3 Ultra (OpenRouter Free)", provider="openrouter", litellm_model="openrouter/nvidia/nemotron-3-ultra-550b-a55b:free", capabilities={"chat","tools","reasoning"}, tier="advanced", cost_tier="low", latency_class="normal", quality_tier="advanced", safety_profile="normal", logo_url="/logos/openrouter.svg"),
