...
ALL_MODELS: List[ModelInfo] = [
    ...
    ModelInfo(
        ...
        safety_profile="normal",
        logo_url="/logos/openrouter.svg",
        persona_type="The Efficient Solver",
        persona_tagline="High-quality reasoning at speed",
        description="Strong general-purpose model with excellent coding and reasoning capabilities",
    ),
    ModelInfo(
        id="mistral-large",
