...
def upgrade() -> None:
    ...
    if "llm_usage_log" not in tables:
        op.create_table(
            "llm_usage_log",
    ...
    if "divergence_report" not in tables:
        op.create_table(
            "divergence_report",
            sa.Column("id", sa.String(), nullable=False),
    ...
    if "red_team_session" not in tables:
        op.create_table(
            "red_team_session",
            sa.Column("id", sa.String(), nullable=False),
            sa.Column("debate_id", sa.String(), nullable=True),
    ...
    if "oracle_session" not in tables:
        op.create_table(
            "oracle_session",
            sa.Column("id", sa.String(), nullable=False),
            sa.Column("user_id", sa.String(), nullable=False),
    ...
    if "oracle_branch" not in tables:
        op.create_table(
            "oracle_branch",
            sa.Column("id", sa.String(), nullable=False),
