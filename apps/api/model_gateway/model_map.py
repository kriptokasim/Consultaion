...
MODEL_MAP: dict[str, dict[str, Any]] = {
    ...
    "router-deep":{"provider":"openrouter","provider_model_id":"poolside/laguna-s-2.1:free","litellm_model":"openrouter/poolside/laguna-s-2.1:free","cost_class":"free","deprecated":False,"replacement":None,"last_verified_at":"2026-08-30","free_tier_verified_at":"2026-08-30","free_tier_source":"OpenRouter","free_tier_limit_notes":"Free endpoint; rate limited."},
    "llama-3-free":{"provider":"openrouter","provider_model_id":"inclusionai/ling-3.0-flash-fin:free","litellm_model":"openrouter/inclusionai/ling-3.0-flash-fin:free","cost_class":"free","deprecated":True,"replacement":"openrouter_fallback","last_verified_at":"2026-08-30","free_tier_verified_at":"2026-08-30","free_tier_source":"OpenRouter","free_tier_limit_notes":"Legacy key retained for persisted panels."},
    "mimo-v2-free":{"provider":"openrouter","provider_model_id":"google/gemma-4-26b-a4b-it:free","litellm_model":"openrouter/google/gemma-4-26b-a4b-it:free","cost_class":"free","deprecated":True,"replacement":"openrouter_fallback","last_verified_at":"2026-08-30","free_tier_verified_at":"2026-08-30","free_tier_source":"OpenRouter","free_tier_limit_notes":"Legacy key retained for persisted panels."},
    # Fourth arena seat. config/model_pools.yaml lists this key in
    # arena_primary_pool and free_hosted_pool, but it only ever existed as a
    # runtime addition under a different spelling (openrouter_nemotron_free), so
    # resolve_model_key() rejected it whenever the free-model runtime had not yet
    # installed -- leaving one of the four arena seats unresolvable. Its three
    # sibling seats (router-smart, router-deep, llama-3-free) are static entries;
    # this one is now consistent with them.
    "openrouter-nemotron-free":{"provider":"openrouter","provider_model_id":"nvidia/nemotron-3-ultra-550b-a55b:free","litellm_model":"openrouter/nvidia/nemotron-3-ultra-550b-a55b:free","cost_class":"free","deprecated":False,"replacement":None,"last_verified_at":"2026-08-30","free_tier_verified_at":"2026-08-30","free_tier_source":"OpenRouter","free_tier_limit_notes":"Free endpoint; rate limited."},
