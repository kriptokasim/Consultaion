...
import { isLiveStatus } from "@/lib/ui/formatters";
        ...
        return (
          ...
          >
            ...
            <header className="flex items-start justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="line-clamp-1 text-sm font-semibold text-amber-900 dark:text-amber-100">
                    {run.id}
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4 flex items-center justify-between text-xs text-stone-600 dark:text-amber-100/70">
              <div className="flex items-center gap-2">
                {/* Pulse dot only for live/active debates */}
                {live && (
                  <span
