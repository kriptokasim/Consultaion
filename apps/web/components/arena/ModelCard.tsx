    ...
    return (
        <div className="p-5 flex-1 flex flex-col items-center justify-center text-center gap-3">
            ...
            <button
                type="button"
                onClick={() => {
                    alert("Retry functionality is coming soon! This will dispatch a targeted run for this model.");
                }}
                className="mt-3 inline-flex items-center justify-center rounded-lg bg-foreground px-4 py-2 text-xs font-semibold text-background shadow hover:bg-foreground/90 transition-colors"
            >
                Retry {displayName}
            </button>
        </div>
