          ...
          {useCases.map((useCase, index) => {
            ...
            return (
              <Reveal key={index} delay={index * 80}>
                <div className="h-full rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-md transition hover:-translate-y-1 hover:shadow-lg backdrop-blur-sm dark:border-slate-800 dark:bg-slate-900/50">
