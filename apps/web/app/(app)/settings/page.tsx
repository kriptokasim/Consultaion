  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-primary dark:text-blue-400">{t("settings.overview.kicker")}</p>
      ...
      <div className="card-elevated max-w-2xl space-y-3 p-6">
        <p className="text-base font-semibold text-slate-900 dark:text-white">{t("settings.overview.cardTitle")}</p>
        <p className="text-sm text-slate-600 dark:text-slate-300">
